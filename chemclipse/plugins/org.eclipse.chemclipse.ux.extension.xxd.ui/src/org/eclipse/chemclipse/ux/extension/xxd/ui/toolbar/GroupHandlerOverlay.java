...
public class GroupHandlerOverlay extends AbstractGroupHandler {
	...
	public List<IPartHandler> getPartHandler() {
		...
		//
		partHandler.add(new OverlayChromatogramPartHandler());
		partHandler.add(new OverlayNMRPartHandler());
		partHandler.add(new OverlayXIRPartHandler());
		partHandler.add(new BaselineChromatogramPartHandler());
		partHandler.add(new ChromatogramHeatmapPartHandler());
		//
		return partHandler;
	}
